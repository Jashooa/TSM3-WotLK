...
function Options:GetOperationOptionsInfo()
	local description = "Warehousing operations contain settings for moving the items in a group. Type the name of the new operation into the box below and hit 'enter' to create a new Warehousing operation."
	local tabInfo = {
		{ text = "General", callback = private.DrawOperationGeneral},
	}
	local relationshipInfo = {
		{
			label = "Move Quantity Settings",
			{key="moveQtyEnabled", label="Set Move Quantity"},
			{key="moveQuantity", label="Move Quantity"},
			{key="stackSizeEnabled", label="Set Stack Size for bags"},
			{key="stackSize", label="Stack Size Multiple"},
			{key="keepBagQtyEnabled", label="Set Keep in Bags Quantity"},
			{key="keepBagQuantity", label="Keep in Bags Quantity"},
			{key="keepBankQtyEnabled", label="Set Keep in Bank Quantity"},
			{key="keepBankQuantity", label="Keep in Bank/GuildBank Quantity"},
		},
		{
			label = "Restock Settings",
			{key="restockQtyEnabled", label="Enable Restock"},
			{key="restockQuantity", label="Restock Quantity"},
			{key="restockStackSizeEnabled", label="Set Stack Size for bags"},
			{key="restockStackSize", label="Stack Size Multiple"},
			{key="restockKeepBankQtyEnabled", label="Set Keep in Bank Quantity"},
			{key="restockKeepBankQuantity", label="Keep in Bank/GuildBank Quantity"},
		},
	}
			...
			children = {
				{
					type = "InlineGroup",
					layout = "flow",
					title = "Move Quantity Settings",
					children = {
						{
							type = "CheckBox",
							label = "Set Move Quantity",
							...
							tooltip = "Enable this to set the quantity to move, if disabled Warehousing will move all of the item",
						},
						{
							...
							max = 5000,
							step = 1,
							tooltip = "Warehousing will move this number of each item",
						},
						{
							type = "Spacer",
						},
						{
							type = "CheckBox",
							label = "Set Stack Size for bags",
							settingInfo = {operationSettings, "stackSizeEnabled"},
							disabled = operationSettings.relationships.stackSizeEnabled,
							callback = function() container:Reload() end,
							tooltip = "Enable this to set the stack size multiple to be moved",
						},
						{
							-- slider to set the move quantity
							type = "Slider",
							label = "Stack Size Multiple",
							...
							max = 200,
							step = 1,
							tooltip = "Warehousing will only move items in multiples of the stack size set when moving to your bags, this is useful for milling/prospecting etc to ensure you don't move items you can't process",
						},
						{
							type = "Spacer",
						},
						...
						},
						{
							...
							max = 5000,
							step = 1,
							tooltip = "Warehousing will ensure this number remain in your bags when moving items to the bank / guildbank.",
						},
						{
							type = "Spacer",
						},
						{
							type = "CheckBox",
							label = "Set Keep in Bank Quantity",
							settingInfo = {operationSettings, "keepBankQtyEnabled"},
							disabled = operationSettings.relationships.keepBankQtyEnabled,
							callback = function() container:Reload() end,
							tooltip = "Enable this to set the quantity to keep back in your bank / guildbank",
						},
						{
							-- slider to set the keep bank qty
							type = "Slider",
							label = "Keep in Bank/GuildBank Quantity",
							...
							max = 5000,
							step = 1,
							tooltip = "Warehousing will ensure this number remain in your bank / guildbank when moving items to your bags.",
						},
					},
				},
				{
					...
					children = {
						{
							...
							callback = function() container:Reload() end,
							tooltip = "Enable this to set the restock quantity",
						},
						{
							-- slider to set the move quantity
							type = "Slider",
							...
							max = 5000,
							step = 1,
							tooltip = "Warehousing will restock your bags up to this number of items",
						},
						{
							type = "Spacer",
						},
						...
						},
						{
							...
							min = 1,
							max = 5000,
							tooltip = "Warehousing will ensure this number remain in your bank / guildbank when restocking items to your bags.",
						},
					},
				},
			},
